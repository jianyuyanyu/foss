...
public class ClientAccessTokenRequestCustomizerTests(ITestOutputHelper output) : IntegrationTestBase(output)
{
    ...
    public async Task Can_use_default_token_request_customizer()
    {
        ...
        CustomizeHttpClientBuilder = builder => builder
            .AddClientAccessTokenHandler(new UserTokenRequestParameters
            {
    ...
    public async Task Can_use_token_request_customizer_factory()
    {
        ...
        CustomizeHttpClientBuilder = builder => builder
            .AddClientAccessTokenHandler(tokenRequestCustomizerFactory, new UserTokenRequestParameters
            {
                Scope = Scope.Parse("scope1")
            });
