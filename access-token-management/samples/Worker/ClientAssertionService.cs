...
public class ClientAssertionService(IOptionsMonitor<ClientCredentialsClient> options) : IClientAssertionService
{
    ...
    public Task<ClientAssertion?> GetClientAssertionAsync(ClientCredentialsClientName? clientName, TokenRequestParameters? parameters = null, CancellationToken ct = default)
    {
