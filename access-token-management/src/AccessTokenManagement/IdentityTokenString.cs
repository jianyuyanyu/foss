...
public readonly record struct IdentityTokenString : IStringValue<IdentityTokenString>
{
    ...
    static IdentityTokenString IStringValue<IdentityTokenString>.Load(string result) => new(result);
