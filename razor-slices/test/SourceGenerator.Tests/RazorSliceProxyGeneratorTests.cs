...
public class RazorSliceProxyGeneratorTests
{
        ...
        bool hasModel, bool useRecords, bool customBase, bool privateConstructor = false)
    {
        ...
        var baseType = customBase ? "TestApp.CustomSlice" : hasModel ? "Duende.RazorSlices.RazorSlice<string>" : "Duende.RazorSlices.RazorSlice";
        var source = $$"""
            #nullable enable
            ...
            {
                public class Model { }
                public abstract class CustomSlice : Duende.RazorSlices.RazorSlice<Model> { }
            }
