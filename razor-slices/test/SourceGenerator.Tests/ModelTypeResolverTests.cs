...
namespace TestNs
{
    ...
    public abstract class DirectTodoSliceBase : Duende.RazorSlices.RazorSlice<TodoModel> { }

    public abstract class GenericTodoSliceBase<TModel> : Duende.RazorSlices.RazorSlice<TModel> { }
    ...
    public abstract class NoModelSliceBase : Duende.RazorSlices.RazorSlice { }

    public abstract class MultiArgMappedSliceBase<TThing, TModel> : Duende.RazorSlices.RazorSlice<TModel> { }

    public abstract class MultiArgMappedFirstSliceBase<TModel, TThing> : Duende.RazorSlices.RazorSlice<TModel> { }

    public abstract class NonModelMappedSliceBase<TThing> : Duende.RazorSlices.RazorSlice<TodoModel> { }
...
";
    ...
    private static string? Resolve(
        ...
        string? rootNamespace = null) => ModelTypeResolver.ResolveModelType(
            modelTypeName,
            usings ?? [],
            TestCompilation,
            rootNamespace);
    ...
    private static string? ResolveFromSliceBaseType(
        string baseTypeName,
        List<UsingDirective>? usings = null,
        string? rootNamespace = null) => ModelTypeResolver.ResolveModelTypeFromSliceBaseType(
            baseTypeName,
            usings ?? [],
            TestCompilation,
            rootNamespace);
