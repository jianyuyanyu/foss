            ...
            else
            {
                ...
                codeBuilder.AppendLine($$"""
                        ...
                        public {{sealedValue}}class {{className}} : global::Duende.RazorSlices.IRazorSliceProxy{{genericParameter}}
                        {
                            ...
                            private static readonly global::Duende.RazorSlices.SliceDefinition _sliceDefinition = new(_sliceType);
                    """);
                ...
                if (hasModel && resolvedModelType is not null)
                {
                    codeBuilder.AppendLine($$"""
                            ...
                            /// </summary>
                            public static global::Duende.RazorSlices.RazorSlice<{{resolvedModelType}}> Create({{resolvedModelType}} model) => _sliceDefinition.CreateSlice<{{resolvedModelType}}>(model);
                ...
                else
                {
                    codeBuilder.AppendLine($$"""
                            ...
                            /// </summary>
                            public static global::Duende.RazorSlices.RazorSlice Create() => _sliceDefinition.CreateSlice();
