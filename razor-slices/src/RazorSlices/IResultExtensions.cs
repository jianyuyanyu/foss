...
public static class ResultsExtensions
{
    ...
    {
        /// <summary>
        /// Render a <see cref="Duende.RazorSlices.RazorSlice" /> template to the response.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// <param name="statusCode">The HTTP status code to set on the response.</param>
        /// <returns>An <see cref="Duende.RazorSlices.RazorSlice"/> that can be rendered to the response.</returns>
        ...
        /// <summary>
        /// Render a <see cref="Duende.RazorSlices.RazorSlice{TModel}" /> template to the response.
        /// </summary>
        /// <typeparam name="TSliceProxy"></typeparam>
        /// <typeparam name="TModel"></typeparam>
        /// <param name="model">The model to pass to the Razor slice.</param>
        /// <param name="statusCode">The HTTP status code to set on the response.</param>
        /// <returns>An <see cref="Duende.RazorSlices.RazorSlice{TModel}"/> that can be rendered to the response.</returns>
...
public static class TypedResultsExtensions
{
    extension(TypedResults)
    {
        ...
        /// <param name="statusCode">The HTTP status code to set on the response.</param>
        /// <returns>A <see cref="Duende.RazorSlices.RazorSlice"/> that can be rendered to the response.</returns>
...
#pragma warning restore CA2000
        ...
        /// <param name="model">The model to pass to the Razor slice.</param>
        /// <param name="statusCode">The HTTP status code to set on the response.</param>
        /// <returns>A <see cref="Duende.RazorSlices.RazorSlice{TModel}"/> that can be rendered to the response.</returns>
